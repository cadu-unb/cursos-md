...
- Tema/ferramenta do curso: [OBJETO BASE — ex.: "Excel para iniciantes",
  "Claude no PowerPoint", "edição de fotos no Canva"]
- Público-alvo: [ex.: pessoas que nunca usaram a ferramenta; professores curiosos]
- Pré-requisitos: [ex.: ter o programa instalado; nenhum conhecimento prévio]
- O que o aluno precisa ter aberto/à mão: [ex.: computador com o software X e internet]

# CONFIGURAÇÃO (ajustar se desejar; caso contrário, manter o padrão)
- Carga horária: [padrão: 60 a 90 minutos]
- Número de oficinas práticas: [padrão: 4 oficinas + 1 projeto final]
- Material-fonte de referência: [opcional: cole ou descreva a base; se ausente,
  gere o conteúdo a partir de conhecimento geral sobre o tema]

# TAREFA
Produza o curso completo respeitando a ESTRUTURA e o ESTILO definidos a seguir.
...
1. TÍTULO
   - Formato: "# [OBJETO BASE] Para Leigos — Curso Hands-on"
...
- Markdown limpo: cabeçalhos, listas numeradas, tabelas curtas e citações para os
  boxes. Separe oficinas com linhas horizontais ("---"). Use emojis SOMENTE nos
  cabeçalhos e boxes previstos acima, não no corpo do texto.
