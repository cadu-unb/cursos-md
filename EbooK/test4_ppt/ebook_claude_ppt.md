...
Este é o [[Claude]{#ocor-claude}](#glos-claude) para [[PowerPoint]{#ocor-powerpoint}](#glos-powerpoint): não um gerador automático de slides, mas um **parceiro criativo** que você pode interrogar, direcionar e refinar para produzir apresentações de qualidade profissional em uma fração do tempo tradicional.

Este e-book foi concebido para **docentes, comunicadores corporativos e criadores de conteúdo** com pouco ou nenhum contato prévio com [[IA Generativa]{#ocor-ia-generativa}](#glos-ia-generativa). Ao longo dos módulos, você vai aprender não apenas a usar ferramentas, mas a **pensar como um designer** usando a inteligência artificial como colaboradora.
...
Ao final de cada módulo, há uma [[**Pílula Hands-on**]{#ocor-pilula}](#glos-pilula) — um exercício prático de 2 a 15 minutos que você pode fazer imediatamente. Não pule essas seções: elas são onde o aprendizado real acontece.
...
Para usar o Claude, você precisa de uma conta [[Microsoft 365]{#ocor-microsoft365}](#glos-microsoft365) ativa com assinatura vigente, conexão de internet estável (Claude processa em nuvem), e um navegador moderno como Chrome, Edge ou Safari se optar pela versão Web.
...
| "Claude demora muito" | Simplifique o [[prompt]{#ocor-prompt}](#glos-prompt). Textos muito longos levam mais tempo. |
...
### 5. [[Gerador de Briefs Visuais]{#ocor-brief-visual}](#glos-brief-visual): Descreve Imagens para Bancos de Dados
...
Esse documento — seu [[briefing]{#ocor-briefing}](#glos-briefing) — é o ponto de partida de tudo. Guarde-o. Você vai usá-lo nos prompts dos próximos módulos.
...
Três técnicas de [[prompt engineering]{#ocor-prompt-engineering}](#glos-prompt-engineering) vão elevar a qualidade das suas respostas significativamente.

### [[Chain-of-Thought]{#ocor-chain-of-thought}](#glos-chain-of-thought): Pedir para Claude Pensar em Voz Alta
...
### [[Few-Shot]{#ocor-few-shot}](#glos-few-shot): Mostrar Exemplos do Que Você Quer
...
### [[Role-Playing]{#ocor-role-playing}](#glos-role-playing): Pedir para Claude Assumir um Papel
...
## A [[Throughline]{#ocor-throughline}](#glos-throughline): O Fio Condutor da Apresentação
...
As [[notas do orador]{#ocor-notas-orador}](#glos-notas-orador) são a solução. Não são um script para ler em voz alta — são um roteiro de segurança que você usa para nunca perder o fio. Com elas, você fala naturalmente, parece preparado sem parecer mecânico, e a apresentação flui como uma conversa.
...
[[VBA]{#ocor-vba}](#glos-vba) (Visual Basic for Applications) é a linguagem de automação do Microsoft Office. Ele permite que você instrua o PowerPoint a realizar tarefas repetitivas de forma automática — sem precisar ser programador.
...
Você tem uma planilha Excel com temas, objetivos e atividades. Ao invés de criar cada apresentação manualmente — o que levaria 20 horas — você descreve a estrutura para o Claude, ele escreve a [[macro]{#ocor-macro}](#glos-macro), a macro lê a planilha e cria automaticamente 20 apresentações. Você revisa cada uma em 2 minutos.
...
Cores não são acaso — elas comunicam emoções antes mesmo que o aluno leia uma palavra. Para escolher uma [[paleta de cores]{#ocor-paleta-cores}](#glos-paleta-cores) adequada, use este prompt:
...
Claude é uma IA generativa. Às vezes ele [[alucina]{#ocor-alucinacao}](#glos-alucinacao) — ou seja, gera informações que parecem corretas mas são inventadas. Isso não é uma falha de caráter; é uma característica técnica de como modelos de linguagem funcionam.
...
*Cada verbete contém um link de retorno (↩) que leva diretamente ao trecho do livro onde o termo aparece pela primeira vez.*

---

### Alucinação {#glos-alucinacao}
[↩ Ver no texto](#ocor-alucinacao)
...
*Veja também: [IA Generativa](#glos-ia-generativa), [Prompt](#glos-prompt)*

---

### Briefing {#glos-briefing}
[↩ Ver no texto](#ocor-briefing)
...
*Veja também: [Prompt](#glos-prompt), [Prompt Engineering](#glos-prompt-engineering)*

---

### Brief Visual {#glos-brief-visual}
[↩ Ver no texto](#ocor-brief-visual)

Descrição detalhada em linguagem natural de uma imagem que o apresentador precisa encontrar ou criar. No contexto deste livro, é o texto gerado pelo Claude para orientar a busca em bancos de imagens como Unsplash, Pexels e Pixabay — especificando estilo, elementos, paleta de cores e tom desejados.

*Veja também: [DALL-E](#glos-dalle), [Paleta de Cores](#glos-paleta-cores)*

---

### Chain-of-Thought {#glos-chain-of-thought}
[↩ Ver no texto](#ocor-chain-of-thought)

Técnica de prompt engineering que instrui o modelo de IA a externalizar seu raciocínio passo a passo antes de chegar à resposta final. Ao pedir que Claude "pense em voz alta", o resultado tende a ser mais preciso, coerente e estruturado — especialmente útil para tarefas pedagógicas com múltiplas variáveis.

*Veja também: [Prompt Engineering](#glos-prompt-engineering), [Few-Shot](#glos-few-shot), [Role-Playing](#glos-role-playing)*

---

### Claude {#glos-claude}
[↩ Ver no texto](#ocor-claude)
...
*Veja também: [IA Generativa](#glos-ia-generativa), [Prompt](#glos-prompt), [Microsoft 365](#glos-microsoft365)*

---

### DALL-E {#glos-dalle}
[↩ Ver no texto](#ocor-dalle)
...
*Veja também: [Brief Visual](#glos-brief-visual), [IA Generativa](#glos-ia-generativa)*

---

### Deck {#glos-deck}

Termo informal amplamente usado no mercado para designar um conjunto de slides — ou seja, uma apresentação completa no PowerPoint. A palavra vem do inglês e é usada especialmente em contextos corporativos e de comunicação profissional.

*Veja também: [PowerPoint](#glos-powerpoint), [Throughline](#glos-throughline)*

---

### EPUB {#glos-epub}

Electronic Publication. Formato aberto e padronizado para publicação de livros digitais, mantido pelo consórcio W3C. É o formato base deste e-book e é compatível com a maioria dos e-readers modernos (Kobo, Apple Books, leitores Android). O Kindle usa uma variação própria (KFX/MOBI), mas o Pandoc realiza a conversão automaticamente.

*Veja também: [Pandoc](#glos-pandoc)*

---

### Few-Shot {#glos-few-shot}
[↩ Ver no texto](#ocor-few-shot)

Técnica de prompt engineering que consiste em fornecer ao modelo de IA dois ou três exemplos concretos do formato ou estilo de resposta desejado antes de fazer a solicitação principal. Ao mostrar ao Claude o padrão esperado, o resultado tende a ser mais consistente e alinhado com o estilo do autor.

*Veja também: [Prompt Engineering](#glos-prompt-engineering), [Chain-of-Thought](#glos-chain-of-thought), [Role-Playing](#glos-role-playing)*

---

### IA Generativa {#glos-ia-generativa}
[↩ Ver no texto](#ocor-ia-generativa)
...
*Veja também: [Claude](#glos-claude), [Prompt](#glos-prompt), [Alucinação](#glos-alucinacao)*

---

### Iteração {#glos-iteracao}

Processo de refinamento progressivo de um resultado por meio de múltiplos turnos de conversa com o Claude. Em vez de buscar o prompt perfeito de uma só vez, a iteração pressupõe que cada resposta é um ponto de partida que pode ser ajustado, expandido ou corrigido no turno seguinte. É a essência do fluxo de trabalho com IA Generativa.
...
*Veja também: [VBA](#glos-vba), [PowerPoint](#glos-powerpoint)*

---

### Microsoft 365 {#glos-microsoft365}
[↩ Ver no texto](#ocor-microsoft365)
...
*Veja também: [PowerPoint](#glos-powerpoint), [VBA](#glos-vba)*

---

### Notas do Orador {#glos-notas-orador}
[↩ Ver no texto](#ocor-notas-orador)
...
[↩ Ver no texto](#ocor-paleta-cores)
...
*Veja também: [Brief Visual](#glos-brief-visual), [Deck](#glos-deck)*

---

### Pandoc {#glos-pandoc}

Ferramenta de linha de comando de código aberto que converte documentos entre diferentes formatos — neste projeto, de Markdown para EPUB. Aceita injeção de folhas de estilo CSS e arquivos de metadados YAML, permitindo controle total sobre a aparência e os metadados do e-book final sem depender de editores visuais.

*Veja também: [EPUB](#glos-epub)*

---

### Pílula Hands-on {#glos-pilula}
[↩ Ver no texto](#ocor-pilula)

Seção de exercício prático ao final de cada capítulo deste livro, com duração estimada de 2 a 15 minutos. Cada pílula propõe uma tarefa concreta e imediata que aplica o conceito recém-apresentado — pressupondo que o aprendizado real acontece na prática, não apenas na leitura.

*Veja também: [Prompt](#glos-prompt), [Iteração](#glos-iteracao)*

---

### PowerPoint {#glos-powerpoint}
[↩ Ver no texto](#ocor-powerpoint)
...
*Veja também: [Microsoft 365](#glos-microsoft365), [Deck](#glos-deck), [VBA](#glos-vba)*

---

### Prompt {#glos-prompt}
[↩ Ver no texto](#ocor-prompt)
...
*Veja também: [Prompt Engineering](#glos-prompt-engineering), [Briefing](#glos-briefing), [Iteração](#glos-iteracao)*

---

### Prompt Engineering {#glos-prompt-engineering}
[↩ Ver no texto](#ocor-prompt-engineering)
...
*Veja também: [Prompt](#glos-prompt), [Chain-of-Thought](#glos-chain-of-thought), [Few-Shot](#glos-few-shot), [Role-Playing](#glos-role-playing)*

---

### Role-Playing {#glos-role-playing}
[↩ Ver no texto](#ocor-role-playing)

Técnica de prompt engineering que consiste em atribuir ao Claude um papel ou persona específica antes de fazer uma solicitação — por exemplo, "você é um professor criativo que explica tudo com analogias do cotidiano". Ao assumir esse papel, o modelo tende a gerar respostas mais alinhadas com o tom, vocabulário e estilo esperados.

*Veja também: [Prompt Engineering](#glos-prompt-engineering), [Chain-of-Thought](#glos-chain-of-thought), [Few-Shot](#glos-few-shot)*

---

### Throughline {#glos-throughline}
[↩ Ver no texto](#ocor-throughline)
...
*Veja também: [Deck](#glos-deck), [Notas do Orador](#glos-notas-orador)*

---

### VBA {#glos-vba}
[↩ Ver no texto](#ocor-vba)
...
*Veja também: [Macro](#glos-macro), [Microsoft 365](#glos-microsoft365), [PowerPoint](#glos-powerpoint)*
