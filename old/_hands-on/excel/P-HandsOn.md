...
1. TÍTULO
   - Formato: `# Claude para Excel: Consultoria Analítica, Fórmulas Complexas e Automação — Curso Hands-on`
   - SUBTÍTULO sem TRADUÇÃO: "Claude for Excel: Analytical Consulting, Complex Formulas and Automation — Curso Hands-on"
