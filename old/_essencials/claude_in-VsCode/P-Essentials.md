  ...
  - Tema/ferramenta do curso: `curso_claude_vs-code.md`
  ...
  - Material-fonte de referência: `curso_claude_vs-code.md`
  ...
  1. TÍTULO
    - Formato: `# (Plano de Aula) Plataformas e integrações: Use o Claude Code no VS Code — Curso Essentials`
    - SUBTÍTULO sem TRADUÇÃO: "Platforms and Integrations: Use Claude Code in VS Code — Curso Essentials"
